...
public class SmartPlayer extends Player {
     ...
     * CONSTRUCTORS
     */
    public SmartPlayer(String tmpName, Color tmpColor) {
        super(tmpName, tmpColor);
    }

    public SmartPlayer(String tmpName, UUID tmpUUID) {
        super(tmpName, tmpUUID);
    }

    public SmartPlayer(String tmpName) {
        super(tmpName);
    }
    ...
    public Turn findOptimalTurnWithOrderedDice(BoardInterface currB, Color c, List<Integer> currDice, List<Move> accMoves) {
        if (currDice.size() == 0) return new Turn(accMoves);
            ...
            for (Move m : nextPossibleMoves) {
                ...
                double currScore = this.scoreFunction(newB);
    ...
    public double scoreFunction(BoardInterface b){
        return b.barNumBoardScore(this.color());
    }
