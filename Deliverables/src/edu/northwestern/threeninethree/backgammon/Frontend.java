...
public class Frontend {
    public static void main(String[] args){
         ...
         */
        String jsonArrayStrings = jsonArrays.stream().filter(x -> !x.isEmpty()).map(x->x.toJSONString()).collect(Collectors.joining(","));
        System.out.print("[" + jsonArrayStrings + "]");
    }
